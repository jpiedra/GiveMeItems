...
var UWindowComboControl WeaponControl[12];
...
function Created()
{
	...
	for (i = 0; i < 6; i++){
		...
		WeaponControl[i] = UWindowComboControl(CreateControl(class'UWindowComboControl', 0, (y * 30) - 20, 250, 15));
		WeaponControl[i].SetEditable(False);
	
		ItemAddBox[i] = UWindowEditControl(CreateControl(class'UWindowEditControl', 10 + 90, (y * 30), 250, 1));
		ItemAddBox[i].SetNumericOnly(False);
		ItemAddBox[i].SetMaxLength(256);
		ItemAddBox[i].EditBoxWidth = 150;
		ItemAddBox[i].Align = TA_Right;

			AddItemButton[i] = UWindowSmallButton(CreateControl(class'UWindowSmallButton', 10 + 90, (y * 30) + 20, 80, 20));
			AddItemButton[i].SetText( " Set Item " $ (i + 1) $ " " );

		AddStatus[i] = UWindowLabelControl(CreateControl(class'UWindowLabelControl', 100 + 90, (y * 30) + 20, 250, 16));
	...
	for (i = 6; i < 12; i++){
		...
		ItemAddBox[i] = UWindowEditControl(CreateControl(class'UWindowEditControl', 230 + 90, (y * 30), 250, 1));
		ItemAddBox[i].SetNumericOnly(False);
		ItemAddBox[i].SetMaxLength(256);
		ItemAddBox[i].EditBoxWidth = 150;
		ItemAddBox[i].Align = TA_Right;

			AddItemButton[i] = UWindowSmallButton(CreateControl(class'UWindowSmallButton', 230 + 90, (y * 30) + 20, 80, 20));
			AddItemButton[i].SetText( " Set Item " $ (i + 1) $ " " );

		AddStatus[i] = UWindowLabelControl(CreateControl(class'UWindowLabelControl', 320 + 90, (y * 30) + 20, 250, 16));
		AddStatus[i].SetFont(F_Bold);
		AddStatus[i].Align = TA_Left;
		AddStatus[i].SetText(" ");
	    ...
	    case DE_Click: // the message sent by buttons
      		switch(C){
				...
				case AddItemButton[0]:
					if(class<Inventory>(DynamicLoadObject(pass[0], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[0] = ItemAddBox[0].GetValue();
				...
				case AddItemButton[1]:
					if(class<Inventory>(DynamicLoadObject(pass[1], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[1] = ItemAddBox[1].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
				...
				case AddItemButton[2]:
					if(class<Inventory>(DynamicLoadObject(pass[2], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[2] = ItemAddBox[2].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
				...
				case AddItemButton[3]:
					if(class<Inventory>(DynamicLoadObject(pass[3], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[3] = ItemAddBox[3].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
				...
				case AddItemButton[4]:
					if(class<Inventory>(DynamicLoadObject(pass[4], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[4] = ItemAddBox[4].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
			...
			case AddItemButton[5]:
					if(class<Inventory>(DynamicLoadObject(pass[5], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[5] = ItemAddBox[5].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
			...
			case AddItemButton[6]:
					if(class<Inventory>(DynamicLoadObject(pass[6], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[6] = ItemAddBox[6].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
			...
			case AddItemButton[7]:
					if(class<Inventory>(DynamicLoadObject(pass[7], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[7] = ItemAddBox[7].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
			...
			case AddItemButton[8]:
					if(class<Inventory>(DynamicLoadObject(pass[8], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[8] = ItemAddBox[8].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
			...
			case AddItemButton[9]:
					if(class<Inventory>(DynamicLoadObject(pass[9], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[9] = ItemAddBox[9].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
			...
			case AddItemButton[10]:
					if(class<Inventory>(DynamicLoadObject(pass[10], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[10] = ItemAddBox[10].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
			...
			case AddItemButton[11]:
					if(class<Inventory>(DynamicLoadObject(pass[11], class'Class')) != None){
						class'GiveMeItems.GiveMeItems'.default.ItemChoice[11] = ItemAddBox[11].GetValue();
						class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
