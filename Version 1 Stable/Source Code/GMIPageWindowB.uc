...
var UWindowComboControl WeaponControl_B[12];
...
function Created()
{
	...
	for (i = 0; i < 6; i++){
		...
		WeaponControl_B[i].SetEditable(True);
		for (d_count = 0; d_count < 35; d_count++){
			WeaponControl_B[i].AddItem(class'GiveMeItems.DefaultItems'.default.Defaults[d_count]);}
		WeaponControl_B[i].SetValue(class'GiveMeItems.GiveMeItems'.default.ItemChoice[i+12]);		
		...
		while(class<Inventory>(DynamicLoadObject(class'GiveMeItems.GiveMeItems'.default.CustomChoice[j], class'Class')) != None && j < 255){
			...
			if(droplist_isDuplicate(class'GiveMeItems.GiveMeItems'.default.CustomChoice[j])){
				weaponcontrol_b[i].AddItem(class'GiveMeItems.GiveMeItems'.default.CustomChoice[j]);
			}
			j++;
		}
...
for (count = 0; count < 12; count++){
	...
	switch(E){ 
			...
			switch(C){
				...
				case Randomize_D:
					for (i = 12; i < 24; i++){
						...
						WeaponControl_B[i-12].SetValue(class'GiveMeItems.GiveMeItems'.default.ItemChoice[i]);
					}
					StaticSaveConfig();
					break;
				case Clear_Customs:
	    ...
	    case DE_Change: // the message sent by buttons
      		switch(C){
        		case WeaponControl_B[0]:
					if(class<Inventory>(DynamicLoadObject(pass[0], class'Class')) != None){
						if(!Is_Default(pass[0])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[12] = WeaponControl_B[0].GetValue();
							process_Custom(WeaponControl_B[0].GetValue());
							...
							AddStatus[0].SetText(" Item #13: Custom Added ");
							...
							AddStatus[0].SetText(" Added Item #13 ");
						...
						AddStatus[0].TextColor.G = 0;
						AddStatus[0].TextColor.B = 0;
						AddStatus[0].SetText(" Item #13: Not added. ");
						SuggestedAmmo[0].SetText(" ");
					} break; 

				case WeaponControl_B[1]:
					if(class<Inventory>(DynamicLoadObject(pass[1], class'Class')) != None){
						if(!Is_Default(pass[1])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[13] = WeaponControl_B[1].GetValue();
							process_Custom(WeaponControl_B[1].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[1].TextColor.R = 0;
							AddStatus[1].TextColor.G = 0;
							AddStatus[1].TextColor.B = 100;
							AddStatus[1].SetText(" Item #14: Custom Added ");
							...
							AddStatus[1].SetText(" Added Item #14 ");
						...
						AddStatus[1].TextColor.G = 0;
						AddStatus[1].TextColor.B = 0;
						AddStatus[1].SetText(" Item #14: Not added. ");
						SuggestedAmmo[1].SetText(" ");
					} break; 

				case WeaponControl_B[2]:
					if(class<Inventory>(DynamicLoadObject(pass[2], class'Class')) != None){
						if(!Is_Default(pass[2])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[14] = WeaponControl_B[2].GetValue();
							process_Custom(WeaponControl_B[2].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[2].TextColor.R = 0;
							AddStatus[2].TextColor.G = 0;
							AddStatus[2].TextColor.B = 100;
							AddStatus[2].SetText(" Item #15: Custom Added ");
							...
							AddStatus[2].SetText(" Added Item #15 ");
						...
						AddStatus[2].TextColor.G = 0;
						AddStatus[2].TextColor.B = 0;
						AddStatus[2].SetText(" Item #15: Not added. ");
						SuggestedAmmo[2].SetText(" ");
					} break; 

				case WeaponControl_B[3]:
					if(class<Inventory>(DynamicLoadObject(pass[3], class'Class')) != None){
						if(!Is_Default(pass[3])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[15] = WeaponControl_B[3].GetValue();
							process_Custom(WeaponControl_B[3].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[3].TextColor.R = 0;
							AddStatus[3].TextColor.G = 0;
							AddStatus[3].TextColor.B = 100;
							AddStatus[3].SetText(" Item #16: Custom Added ");
							...
							AddStatus[3].SetText(" Added Item #16 ");
						...
						AddStatus[3].TextColor.G = 0;
						AddStatus[3].TextColor.B = 0;
						AddStatus[3].SetText(" Item #16: Not added. ");
						SuggestedAmmo[3].SetText(" ");
					} break; 

				case WeaponControl_B[4]:
					if(class<Inventory>(DynamicLoadObject(pass[4], class'Class')) != None){
						if(!Is_Default(pass[4])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[16] = WeaponControl_B[4].GetValue();
							process_Custom(WeaponControl_B[4].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[4].TextColor.R = 0;
							AddStatus[4].TextColor.G = 0;
							AddStatus[4].TextColor.B = 100;
							AddStatus[4].SetText(" Item #17: Custom Added ");
							...
							AddStatus[4].SetText(" Added Item #17 ");
						...
						AddStatus[4].TextColor.G = 0;
						AddStatus[4].TextColor.B = 0;
						AddStatus[4].SetText(" Item #17: Not added. ");
						SuggestedAmmo[4].SetText(" ");
					} break; 

				case WeaponControl_B[5]:
					if(class<Inventory>(DynamicLoadObject(pass[5], class'Class')) != None){
						if(!Is_Default(pass[5])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[17] = WeaponControl_B[5].GetValue();
							process_Custom(WeaponControl_B[5].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[5].TextColor.R = 0;
							AddStatus[5].TextColor.G = 0;
							AddStatus[5].TextColor.B = 100;
							AddStatus[5].SetText(" Item #18: Custom Added ");
							...
							AddStatus[5].SetText(" Added Item #18 ");
						...
						AddStatus[5].TextColor.G = 0;
						AddStatus[5].TextColor.B = 0;
						AddStatus[5].SetText(" Item #18: Not added. ");
						SuggestedAmmo[5].SetText(" ");
					} break; 

				case WeaponControl_B[6]:
					if(class<Inventory>(DynamicLoadObject(pass[6], class'Class')) != None){
						if(!Is_Default(pass[6])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[18] = WeaponControl_B[6].GetValue();
							process_Custom(WeaponControl_B[6].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[6].TextColor.R = 0;
							AddStatus[6].TextColor.G = 0;
							AddStatus[6].TextColor.B = 100;
							AddStatus[6].SetText(" Item #19: Custom Added ");
							...
							AddStatus[6].SetText(" Added Item #19 ");
						...
						AddStatus[6].TextColor.G = 0;
						AddStatus[6].TextColor.B = 0;
						AddStatus[6].SetText(" Item #19: Not added. ");
						SuggestedAmmo[6].SetText(" ");
					} break; 

				case WeaponControl_B[7]:
					if(class<Inventory>(DynamicLoadObject(pass[7], class'Class')) != None){
						if(!Is_Default(pass[7])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[19] = WeaponControl_B[7].GetValue();
							process_Custom(WeaponControl_B[7].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[7].TextColor.R = 0;
							AddStatus[7].TextColor.G = 0;
							AddStatus[7].TextColor.B = 100;
							AddStatus[7].SetText(" Item #20: Custom Added ");
							...
							AddStatus[7].SetText(" Added Item #20 ");
						...
						AddStatus[7].TextColor.G = 0;
						AddStatus[7].TextColor.B = 0;
						AddStatus[7].SetText(" Item #20: Not added. ");
						SuggestedAmmo[7].SetText(" ");
					} break; 

				case WeaponControl_B[8]:
					if(class<Inventory>(DynamicLoadObject(pass[8], class'Class')) != None){
						if(!Is_Default(pass[8])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[20] = WeaponControl_B[8].GetValue();
							process_Custom(WeaponControl_B[8].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[8].TextColor.R = 0;
							AddStatus[8].TextColor.G = 0;
							AddStatus[8].TextColor.B = 100;
							AddStatus[8].SetText(" Item #21: Custom Added ");
							...
							AddStatus[8].SetText(" Added Item #21 ");
						...
						AddStatus[8].TextColor.G = 0;
						AddStatus[8].TextColor.B = 0;
						AddStatus[8].SetText(" Item #21: Not added. ");
						SuggestedAmmo[8].SetText(" ");
					} break; 

				case WeaponControl_B[9]:
					if(class<Inventory>(DynamicLoadObject(pass[9], class'Class')) != None){
						if(!Is_Default(pass[9])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[21] = WeaponControl_B[9].GetValue();
							process_Custom(WeaponControl_B[9].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[9].TextColor.R = 0;
							AddStatus[9].TextColor.G = 0;
							AddStatus[9].TextColor.B = 100;
							AddStatus[9].SetText(" Item #22: Custom Added ");
							...
							AddStatus[9].SetText(" Added Item #22 ");
						...
						AddStatus[9].TextColor.G = 0;
						AddStatus[9].TextColor.B = 0;
						AddStatus[9].SetText(" Item #22: Not added. ");
						SuggestedAmmo[9].SetText(" ");
					} break; 

				case WeaponControl_B[10]:
					if(class<Inventory>(DynamicLoadObject(pass[10], class'Class')) != None){
						if(!Is_Default(pass[10])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[22] = WeaponControl_B[10].GetValue();
							process_Custom(WeaponControl_B[10].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[10].TextColor.R = 0;
							AddStatus[10].TextColor.G = 0;
							AddStatus[10].TextColor.B = 100;
							AddStatus[10].SetText(" Item #23: Custom Added ");
							...
							AddStatus[10].SetText(" Added Item #23 ");
						...
						AddStatus[10].TextColor.G = 0;
						AddStatus[10].TextColor.B = 0;
						AddStatus[10].SetText(" Item #23: Not added. ");
						SuggestedAmmo[10].SetText(" ");
					} break; 

				case WeaponControl_B[11]:
					if(class<Inventory>(DynamicLoadObject(pass[11], class'Class')) != None){
						if(!Is_Default(pass[11])){
							class'GiveMeItems.GiveMeItems'.default.ItemChoice[23] = WeaponControl_B[11].GetValue();
							process_Custom(WeaponControl_B[11].GetValue());
							class'GiveMeItems.GiveMeItems'.static.StaticSaveConfig();
							AddStatus[11].TextColor.R = 0;
							AddStatus[11].TextColor.G = 0;
							AddStatus[11].TextColor.B = 100;
							AddStatus[11].SetText(" Item #24: Custom Added ");
							...
							AddStatus[11].SetText(" Added Item #24 ");
						...
						AddStatus[11].TextColor.G = 0;
						AddStatus[11].TextColor.B = 0;
						AddStatus[11].SetText(" Item #24: Not added. ");
						SuggestedAmmo[11].SetText(" ");
					} break; 
